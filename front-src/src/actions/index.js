...
OPEN_CLOSE_FULL_SCREEN, OPEN_INFO_ALERT, ALERT_MESSAGE, USER_MEDIA_SETTINGS, UPDATE_MEDIA_SOURCE, 
CREATE_OR_UPDATE_MEDIA_SOURCE } from './Types';
...
export const createOrUpdateMediaSource = payload => {
	store.dispatch({
		type: CREATE_OR_UPDATE_MEDIA_SOURCE,
		payload
	});
}
